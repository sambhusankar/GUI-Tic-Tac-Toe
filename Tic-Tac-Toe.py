...
class Game:
    #initializing the GUI and variables here
    def __init__(self):
        self.root = Tk()
    ...
    #creating the game label paler name and reset button
    ...
    #login for checking the winner
    def CheckWin(self):
        wins = [
            [B1["text"], B2["text"], B3["text"]], #horizontal check
            [B4["text"], B5["text"], B6["text"]], #horizontal check
            [B7["text"], B8["text"], B9["text"]], #horizontal check
            [B1["text"], B4["text"], B7["text"]], #vertical check
            [B2["text"], B5["text"], B8["text"]], #vertical check
            [B3["text"], B6["text"], B9["text"]], #vertical check
            [B1["text"], B5["text"], B9["text"]], #diagnonal check
            [B3["text"], B5["text"], B7["text"]]  #diagnonal check
        ]
    ...
    #creating the game board to play 3x3 buttons
